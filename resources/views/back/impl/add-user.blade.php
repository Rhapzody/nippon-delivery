                    ...
                    <div class="card">
                        ...
                        <form class="card-body" action="" method="POST" >
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control" id="password_1" name="password" placeholder="รหัสผ่าน">
                            </div>
                            <div class="form-group">
                                <label for="password">ยืนยัน password</label>
                                <input type="password" class="form-control" id="password_2" placeholder="รหัสผ่านอีกครั้ง">
                            </div>
