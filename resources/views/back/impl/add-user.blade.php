            ...
            <div class="row">
                <div class="col-md-11 mx-auto">
                    <div class="card">
                        ...
                        <form class="card-body" action="{{url('/staff/user/add/process')}}" method="POST" enctype="multipart/form-data" id="add-user">
                            ...
                            <div class="form-group">
                                <label for="user_name"><span class="text-danger">*</span>User name (ตัวอักษรอย่างน้อย 6 ตัว)</label>
                            ...
                            <div class="form-group">
                                <label for="password"><span class="text-danger">*</span>password (A-Z, a-z, 0-9 อย่างน้อยอย่างละ 1 ตัว ความยาว 6 ตัวอักษร)</label>
